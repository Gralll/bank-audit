(function() {
    ...
    function AuditDetailController($scope, $rootScope, $stateParams, previousState, entity, Audit, RateData, RateResult) {
        ...
        $scope.labels = [
            ...
            "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "M1. Обеспечение ИБ при назначении и распределении ролей и обеспечении доверия к персоналу", "M1. Обеспечение ИБ при назначении и распределении ролей и обеспечении доверия к персоналу", "",
            "", "", "", "", "", "", "", "", "", "", "", "", "", ""
        ];
        $scope.data = [
            100, 85, 45, 65, 75,
        ...
        $scope.colors = [
            "#39D213", "#13D3A6", "#F32720", "#F39820", "#E4F220",
            "#13D3A6", "#F39820", "#39D213", "#13D3A6", "#F32720",
            "#F39820", "#E4F220", "#E4F220", "#F32720", "#E4F220",
            "#F32720", "#F32720", "#E4F220", "#13D3A6", "#F39820",
            "#F32720", "#E4F220", "#E4F220", "#F39820", "#F39820",
            "#E4F220", "#F32720", "#F39820", "#E4F220", "#F32720",
            "#E4F220", "#E4F220", "#13D3A6", "#E4F220"
        ];
        ...
        $scope.colors2 = [
            "#13D3A6", "#13D3A6", "#13D3A6", "#13D3A6", "#13D3A6",
            "#13D3A6", "#13D3A6", "#13D3A6", "#13D3A6", "#13D3A6",
            "#E4F220", "#E4F220", "#E4F220", "#E4F220", "#E4F220",
            "#E4F220", "#E4F220", "#F39820", "#F39820", "#F39820",
            "#F39820", "#F39820", "#F39820", "#F39820", "#F39820",
            "#F39820", "#F39820", "#13D3A6", "#13D3A6", "#13D3A6",
            "#13D3A6", "#13D3A6", "#13D3A6", "#13D3A6"
        ];
        ...
        this.getRandomNulls = function () {
            return Math.random() > 0.3 ? 0 : Math.round(Math.random() * 3);
        }
