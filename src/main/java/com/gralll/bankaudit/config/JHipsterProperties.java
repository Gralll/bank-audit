...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "bankAudit@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "bankAudit API";

        private String description = "bankAudit API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "bankAudit";
